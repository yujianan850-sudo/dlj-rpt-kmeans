...
from database.mongo.get_data import getDeviceCurrentData, get_value_org_data, \
    load_model_by_imei, select_model_type
...
def get_data_from_old(imei, startTime, endTime):
    ...
    data,deviceType = get_value_org_data(imei, startTime, endTime)
    print(data,'data')
...
def get_data_list(dt):
    ...
    return values_and_times,deviceType
